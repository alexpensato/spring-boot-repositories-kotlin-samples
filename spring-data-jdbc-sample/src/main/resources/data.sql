INSERT INTO college (id, name, city) VALUES (1, 'University of California', 'Berkeley') ON CONFLICT (id) DO NOTHING;
INSERT INTO college (id, name, city) VALUES (2, 'Harvard University', 'Cambridge') ON CONFLICT (id) DO NOTHING;
